...
// Create layers
// Translated from python code at https://github.com/pytorch/vision/blob/master/torchvision/models/vgg.py
...
VGGNet19Impl::VGGNet19Impl(const std::string &scriptmodule_file_path,
                       const std::set<size_t> &selected_layer_idxs_)
    : VGGNetImpl(
          {Layer::CONV64, Layer::CONV64, Layer::MAXPOOL,
           Layer::CONV128, Layer::CONV128, Layer::MAXPOOL,
           Layer::CONV256, Layer::CONV256, Layer::CONV256, Layer::CONV256, Layer::MAXPOOL,
           Layer::CONV512, Layer::CONV512, Layer::CONV512, Layer::CONV512, Layer::MAXPOOL,
           Layer::CONV512, Layer::CONV512, Layer::CONV512, Layer::CONV512, Layer::MAXPOOL},
          selected_layer_idxs_,
          false,
