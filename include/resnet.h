...
namespace resnet
{
    ...
    private:
        ...
        torch::nn::Conv2d conv{conv3x3(3, 16)}; // 将通道数从3变换为16
    ...
    template <typename Block>
    ResNetImpl<Block>::ResNetImpl(const std::array<int64_t, 3> &layers, int64_t num_classes) : layer1(make_layer(16, layers[0])),
